...
const Hero= ()=> {
    return(
        <div className="grid lg:grid-cols-2 md:grid-cols-2">
            ...
            <Image src="/images/Profile picture (1).jpg" alt="my picture" width={500} height={500} className="rounded-full ml-[10%] "/></div>
            <div>
            <h2 className=" text-6xl text-left gap-y-2 ml-[10%] font-bold text-green-600 mt-16">Hello<br/><br/> I am <br/>Zareen Arif <br/>wellcome to my portfolio</h2>
