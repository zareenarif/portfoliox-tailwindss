    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a className="text-indigo-500 ">zarfeen.zareen@gmail.com</a>
        ...
        <button className="inline-flex text-[50px] text-blue-600 border-0 py-2 px-6  hover:bg-green-900 rounded text-lg">
        <FaLinkedin />
        </button></a>
        <button className="inline-flex text-[50px] text-purple-600 border-0 py-3 px-8  hover:bg-green-900 rounded text-lg">
        <FaGithub />
        </button>
        <button className="inline-flex text-[50px] text-blue-500 border-0 py-2 px-6  hover:bg-green-900 rounded text-lg">
        <FaFacebookSquare />
        </button>
        <button className="inline-flex text-[50px] text-red-600 border-0 py-2 px-6  hover:bg-green-900 rounded text-lg">
        <SiInstagram />
        </button>
        <button className="inline-flex text-[50px] text-blue-600 border-0 py-2 px-6  hover:bg-green-900 rounded text-lg">
        <FaTwitter />
